...
const HeroStickyToast = () => {
  return (
    <div className="absolute top-5/7 left-2/10 -translate-x-1/2 sm:translate-x-0 sm:-left-1/9 z-10 flex flex-col gap-2 items-center justify-center bg-white rounded-lg shadow-lg py-1 sm:py-2 px-3 sm:px-5 scale-90 sm:scale-100">
      ...
      <p className="font-semibold text-[#101828] text-[8px] sm:text-sm text-center">₦21,000.00</p>
    </div>
  );
};
