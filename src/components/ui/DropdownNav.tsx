...
const DropdownNav = ({
  ...
  return (
    <Link
      to={route}
      className="flex items-center justify-start gap-2 xl:gap-4 w-full cursor-pointer hover:bg-[#F2F4F7] transition-colors rounded-2xl py-3 px-0 lg:px-5 col-span-1"
      onClick={closeMenus}
    >
