  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4 justify-center items-center mb-6 sm:mb-8">
        <div
          className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#101828]"
          data-aos="fade-down"
        >
          £100
        </div>
        ...
        <div
          className="flex items-center justify-between gap-2.5 py-1 px-3 bg-[#F3F4F8] rounded-full"
          data-aos="fade-down"
        >
      ...
      <div className="flex flex-col gap-4 sm:gap-5">
        <div className="flex items-center justify-between">
          ...
          <span
            className="text-[#101828] text-xs sm:text-sm"
            data-aos="fade-left"
          >
            100 GBP
          </span>
        ...
        <div className="flex items-center justify-between">
          ...
          <span
            className="text-[#12B76A] text-xs sm:text-sm"
            data-aos="fade-left"
          >
            Free
          </span>
