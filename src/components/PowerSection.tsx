  ...
  return (
    <section className="bg-[#FAFCFF] px-2.5 pb-16 w-full">
      ...
      >
        ...
        <div className="z-10 flex flex-col items-center justify-center  gap-4 sm:gap-6 md:gap-8 min-w-4/9 lg:min-w-4/10 ">
          {/* Heading */}
          <h1 className="font-semibold text-3xl sm:text-3xl md:text-4xl lg:text-5xl z-10 max-w-md sm:max-w-xl lg:max-w-[778px] leading-auto mx-2.5" data-aos='fade-left'>
